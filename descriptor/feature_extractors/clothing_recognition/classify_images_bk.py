...
"""
def classify_loaded_images(images, clothing_model, clothing_category_bin, clothing_color_bin,
                           whole_body_list, top_list, bottom_list, params,
                           whole_body_model=None, whole_body_category_bin=None, whole_body_color_bin=None,
                           top_model=None, top_category_bin=None, top_color_bin=None,
                           bottom_model=None, bottom_category_bin=None, bottom_color_bin=None):
"""
def classify_loaded_images(images,models_dict):
    ...
    :type clothing_model: Tensorflow model
    :param clothing_model: trained general clothing model

    :type clothing_category_bin: sklearn LabelBinarizer
    :param clothing_category_bin: label binarizer for general clothing categories

    :type clothing_color_bin: sklearn LabelBinarizer
    :param clothing_color_bin: label binarizer for general clothing colors

    :type whole_body_list: list
    :param whole_body_list: list of whole body garments

    :type top_list: list
    :param top_list: list of top garments

    :type bottom_list: list
    :param bottom_list: list of bottom garments

    :type params: dictionary
    :param params: dictionary with parameters

    :type whole_body_model: Tensorflow model
    :param whole_body_model: trained general whole_body model

    :type whole_body_category_bin: sklearn LabelBinarizer
    :param whole_body_category_bin: label binarizer for general whole_body categories

    :type whole_body_color_bin: sklearn LabelBinarizer
    :param whole_body_color_bin: label binarizer for general whole_body colors

    :type top_model: Tensorflow model
    :param top_model: trained general top model

    :type top_category_bin: sklearn LabelBinarizer
    :param top_category_bin: label binarizer for general top categories

    :type top_color_bin: sklearn LabelBinarizer
    :param top_color_bin: label binarizer for general top colors

    :type bottom_model: Tensorflow model
    :param bottom_model: trained general bottom model

    :type bottom_category_bin: sklearn LabelBinarizer
    :param bottom_category_bin: label binarizer for general bottom categories

    :type bottom_color_bin: sklearn LabelBinarizer
    :param bottom_color_bin: label binarizer for general bottom colors
    ...
    if whole_body_model is not None:
        whole_body_result = clothing_model.predict(whole_body_pp_images, batch_size=batch_size)
    ...
    for im_counter in range(0, len(images)):
        ...
        if whole_body_most_prob_cat in whole_body_list and (top_most_prob_col == bottom_most_prob_col):
            ...
            cat_col_label = (top_most_prob_col + ' ' + top_most_prob_cat + ' - '
                             + bottom_most_prob_cat + ' ' + bottom_most_prob_cat_prob)
            cat_col_prob = (top_most_prob_cat_prob + top_most_prob_col_prob
                            + bottom_most_prob_cat_prob + bottom_most_prob_col_prob) / 2 * \
                top_most_prob_col_prob * bottom_most_prob_col_prob
            result.append((cat_col_label, cat_col_prob))
